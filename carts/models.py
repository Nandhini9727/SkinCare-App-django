...
class CartItem(models.Model):
     # list of all the fields that we neeed for CartItem model
    ...
    cart = models.ForeignKey(Cart, on_delete=models.CASCADE) # models.CASCADE is used for deleting all cart item if cart that is deleted
